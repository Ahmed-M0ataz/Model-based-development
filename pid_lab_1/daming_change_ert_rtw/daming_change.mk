###########################################################################
## Makefile generated for component 'daming_change'. 
## 
## Makefile     : daming_change.mk
## Generated on : Thu Nov 09 19:24:44 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/daming_change.elf
...
SLIB_PATH                 = C:/Users/LAPTOP~1.COM/DOCUME~1/MATLAB/R2022a/ARDUIN~1/ARDUIN~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/daming_change.elf
...
DEFINES_STANDARD = -DMODEL=daming_change -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o ArduinoPinHandleMap.o MW_PWM.o MW_PWMDriver.o xcp_ext_mode.o daming_change.o daming_change_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/daming_change_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/daming_change_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/daming_change_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_AnalogInput.o : C:/ProgramData/MATLAB/SupportPackages/R2022a/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
daming_change.o : $(START_DIR)/daming_change_ert_rtw/daming_change.c
	$(CC) $(CFLAGS) -o "$@" "$<"


daming_change_data.o : $(START_DIR)/daming_change_ert_rtw/daming_change_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/daming_change_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
